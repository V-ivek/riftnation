import { CardAggregateRefreshParams } from '../../domain/aggregates/card.aggregate';
...
export function toCardRefreshParams(
  source: CardSourceRecord,
  now: Date = new Date(),
): CardAggregateRefreshParams {
  return {
